...
const BlogListing = () => {
  ...
  useEffect(() => {
    // Fetch blogs from API (no manual refresh button, auto-refresh on changes)
    let abort = false;
  ...
  // Removed manual refresh; feed auto-updates via effect dependencies
      ...
      <div className="w-full flex justify-center pt-8 pb-6 px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="w-full max-w-7xl z-10 flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          ...
          <div className="flex items-center gap-3">
            ...
            {/* Feed auto-refreshes; manual refresh removed */}
          </div>
